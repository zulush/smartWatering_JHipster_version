<template>
  <div>
    <h2 id="page-heading" data-cy="PlanteHeading">
      <span id="plante-heading">Plantes</span>
      ...
      <table class="table table-striped" aria-describedby="plantes">
        <thead>
          <tr>
            ...
            <th scope="row"><span>Racine</span></th>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="smartWateringApp.plante.delete.question" data-cy="planteDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-plante-heading">Are you sure you want to delete this Plante?</p>
      </div>
